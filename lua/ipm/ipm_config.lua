...
iPM.Teams = {-- Don't Touch
	...
	["IMPERIALS"] = {
		["TEAMS"] = {
			[TEAM_4_1] = {"sparrow_laat_rescue"},
			[TEAM_4_2] = {"sparrow_laat_rescue"},
			[TEAM_2_4] = {"lfs_fb_laatigunship", "lunasflightschool_niksacokica_74-z_speeder_bike","lunasflightschool_niksacokica_k79-s80","kingpommes_lfs_atte","lunasflightschool_niksacokica_y-45","lunasflightschool_tiefighterdigger","lunasflightschool_tiebomberdigger"},
		},
		["COLOR"] = {88, 175, 252}
	},
